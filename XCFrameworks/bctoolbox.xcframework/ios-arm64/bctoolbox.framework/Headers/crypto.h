...
#define BCTBX_KEM_MLKEM512 0x00001000
#define BCTBX_KEM_MLKEM768 0x00002000
#define BCTBX_KEM_MLKEM1024 0x00004000
...
BCTBX_PUBLIC int32_t bctbx_ssl_handshake2(bctbx_ssl_context_t *ssl_ctx, void *isRunning);
